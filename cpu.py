...
class CPU:
    ...
    def jeq(self, MAR, MDR):
        """If the flag is true, jump to the address stored in the given register. Otherwise, proceed down the stack."""
    ...
    def jne(self, MAR, MDR):
        """If the flag is clear/false, jump to the address stored in the given register. Otherwise, proceed down the stack."""
